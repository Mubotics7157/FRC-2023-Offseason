...
public class CommonConversions {
  ...
  public static double stepsToMeters(double steps){
    return steps*((DriveConstants.WHEEL_DIAMETER_METERS * Math.PI) / (2048*DriveConstants.DRIVE_GEAR_RATIO));
  }
   ...
   public static double inchesToSteps(double inches,double wheelDiameter,double gearRatio){
    return (inches/(wheelDiameter*Math.PI)) * 2048*DriveConstants.DRIVE_GEAR_RATIO;
  }
  ...
  public static double RPMToStepsPerDecisec(double velRPM, double gearing){
     return (velRPM * 2048/600) * gearing;
  }

  public static double stepsPerDecisecToRPM(double nativeVel, double gearing){
    return (nativeVel/2048*600) / gearing;
  }
